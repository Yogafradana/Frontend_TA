...
const Menu = () => {
  const { cartItems, addToCart, updateKeterangan } = useContext(StoreContext);
              ...
              <div className={`menu-details ${selectedMenu ? "active" : ""}`}>
                {selectedMenu && (
                  <div>
                    ...
                    <img
                      src={selectedMenu.gambar}
                      alt={selectedMenu.nama_menu}
                    />
                    <p>
                      <strong>Nama:</strong> {selectedMenu.nama_menu}
                    </p>
                    <p>
                      <strong>Deskripsi:</strong> {selectedMenu.deskripsi}
                    </p>
                    <p>
                      <strong>Harga:</strong> {selectedMenu.harga}
                    </p>
                  ...
                  return (
                    <div className="menu-card-order-box-item" key={index}>
                      ...
                      <p>
                        ...
                        <textarea
                          onChange={(e) =>
                            handleKeterangan(e.target.value, item)
                          }
                        ></textarea>
                      </p>
                    </div>
