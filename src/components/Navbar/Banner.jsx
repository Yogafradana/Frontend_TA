...
const Banner = () => {
  return (
    <div className="container remove-padding">
      <img
        className="gambar-bacground-home"
        src="http://localhost:3000/static/media/header.907d2ef5e6c4cec6edff.png"
        alt="Snow"
      />
      ...
      <div className="top-right p-4">
        <Navbar />
      </div>
      {/* <div className="bottom-right">Bottom Right</div> */}
      <div className="centered">
        <h1 className="banner-header">
          Bug Membandel? Temukan Solusinya Sambil Ngopi di <br />
