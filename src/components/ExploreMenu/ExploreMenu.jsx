  ...
  const settings = {
    ...
    customPaging: (i) => (
      <div
        ...
        className={
          i === 0 ? `div-item-home-active-first` : "div-item-home-active"
        }
      >
        {/* {i + 1} */}
        &nbsp;
  ...
  const getRecommendationMenu = async () => {
    try {
      const response = await axios.get(
        "http://127.0.0.1:8000/api/menu/rekomendasi"
      );
                      ...
                      <div className="menu-home-list-item" key={index}>
                        <div className="card">
                          ...
                          <div className="card-body">
                            <h5 className="card-title-home-list">
                              {item.nama_menu}
                            </h5>
                            <p className="card-sub-title-home-list">
                              {item.deskripsi}...{" "}
                              <span className="card-sub-title-home-list-detail">
                                Detail
                              </span>
                            </p>
                            <NominalFormat
                              className={"card-sub-title-home-list-price"}
                              value={item.harga}
                            />
                          </div>
                        </div>
